...
public class ExemploSobrecarga {
	 ...
	 * 
	 * Por exemplo, na nossa classe Gerente, imagine um outro novo método autentica
	 * que recebe além da senha também o login: public class Gerente extends
	 * Funcionario {
	 * 
	 * private int senha;
	 * 
	 ...
	 * } else { return false; } }
	 * 
	 * //novo método, recebendo dois params public boolean autentica(String login,
	 * int senha) { //implementacao omitida }
	 * 
	 * //outros métodos omitidos }
	 * 
	 * Repare que criamos uma nova versão do método
	 * autentica. Agora temos dois métodos autentica na mesma classe que variam na
	 * quantidade ou tipos de parâmetros. Isso se chama sobrecarga de métodos.
	 * 
	 * A sobrecarga não leva em conta a visibilidade ou retorno do método, apenas os
	 * parâmetros e não depende da herança.
	 */
}
